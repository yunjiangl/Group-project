...
public interface BillService {
	 ...
	 *            </p>
	 */
	void deleteBillInfo(Long bill_id);
	 ...
	 *         </p>
	 */
	String queryBillInfo(Long account_id, int page, int incomeOrExpend);
	 ...
	 */
	String fuzzyQueryBillInfo(Long account_id, String bill_pay_type, int page, int incomeOrExpend);
	 ...
	 */
	String queryBillMoney(Long account_id, int incomeOrExpend);
	 ...
	 * @return 查询到的数据的json格式字符串
	 */
	String queryBillCreateDate(Long account_id, int incomeOrExpend);
